...
OTF2_Paradigm getParadigm(Paradigm paradigm);
...
void Otf2Writer::enterProgram(const CallbackManager& cbManager,
                              int                    userEvent,
                              const Event&           event,
                              CallbackData*          cbData)
{
...
void Otf2Writer::leaveProgram(const CallbackManager& cbManager,
                              int                    userEvent,
                              const Event&           event,
                              CallbackData*          cbData)
{
...
void Otf2Writer::writeStrings(OTF2_GlobalDefWriter* writer,
                              const GlobalDefs&     defs)
{
...
void Otf2Writer::writeLocationGroups(OTF2_GlobalDefWriter* writer,
                                     const GlobalDefs&     defs)
{
...
void Otf2Writer::writeTopologies(OTF2_GlobalDefWriter* writer,
                                 const GlobalDefs&     defs)
{
...
OTF2_Paradigm getParadigm(const Paradigm paradigm)
{
