...
template< typename DefClassT >
DefClassT*
DefinitionContainer< DefClassT >::getItemById(
    const typename DefClassT::IdType id) const
{
...
template< typename DefClassT >
bool
DefinitionContainer< DefClassT >::lessThanId(
    const DefClassT* const           lhs,
...
template< typename DefClassT >
bool
DefinitionContainer< DefClassT >::equalToId(
    const DefClassT* const           lhs,
    const typename DefClassT::IdType rhs)
{
    return lhs->getId() == rhs;
