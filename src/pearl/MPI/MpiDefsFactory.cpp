...
void MpiDefsFactory::createCommunicator(MutableGlobalDefs& defs,
                                        const uint32_t     id,
...
void MpiDefsFactory::createGroupingSet(MutableGlobalDefs&             defs,
                                       const uint32_t                 id,
                                       const uint32_t                 nameId,
...
{
    if (type == GroupingSet::COMM_SET && paradigm == Paradigm::MPI)
    {
...
void MpiDefsFactory::createMpiWindow(MutableGlobalDefs& defs,
                                     ident_t            id,
