...
TEST(FlagsT, constructor_default_initializesFlagBitsToZero)
{
...
TEST(FlagsT, constructor_flagEnum_initializesFlagBits)
{
...
TEST(FlagsT, operatorAndEq_flagEnum_keepsFlagBits)
{
...
TEST(FlagsT, operatorAndEq_flagsItem_keepsFlagBits)
{
...
TEST(FlagsT, operatorOrEq_flagEnum_setsFlagBits)
{
    MyClass::Flags item;
    item |= MyClass::FLAG_B;
...
TEST(FlagsT, operatorOrEq_flagsItem_setsFlagBits)
{
    const MyClass::Flags flagB(MyClass::FLAG_B);
    const MyClass::Flags flagC(MyClass::FLAG_C);
...
TEST(FlagsT, set_flagEnum_setsFlagBits)
{
    MyClass::Flags item;
...
TEST(FlagsT, set_flagsItem_setsFlagBits)
{
    const MyClass::Flags flagB(MyClass::FLAG_B);
    const MyClass::Flags flagD(MyClass::FLAG_D);
...
TEST(FlagsT, unset_flagEnum_unsetsFlagBits)
{
...
TEST(FlagsT, unset_flagsItem_unsetsFlagBits)
{
    const MyClass::Flags flagA(MyClass::FLAG_A);
    const MyClass::Flags flagB(MyClass::FLAG_B);
    const MyClass::Flags flagD(MyClass::FLAG_D);
...
TEST(FlagsT, test_flagEnum_returnsStatus)
{
    MyClass::Flags item;
...
TEST(FlagsT, test_flagsItem_returnsStatus)
{
    const MyClass::Flags none;
    const MyClass::Flags flagA(MyClass::FLAG_A);
    const MyClass::Flags flagB(MyClass::FLAG_B);
...
TEST(FlagsT, operatorEquals_equalItems_returnsTrue)
{
    const MyClass::Flags none;
    const MyClass::Flags flagC(MyClass::FLAG_C);
...
TEST(FlagsT, operatorEquals_unequalItems_returnsFalse)
{
    const MyClass::Flags flagA(MyClass::FLAG_A);
    const MyClass::Flags flagB(MyClass::FLAG_B);
...
TEST(FlagsT, operatorNotEquals_equalItems_returnsFalse)
{
    const MyClass::Flags none;
    const MyClass::Flags flagC(MyClass::FLAG_C);
...
TEST(FlagsT, operatorNotEquals_unequalItems_returnsTrue)
{
    const MyClass::Flags flagA(MyClass::FLAG_A);
    const MyClass::Flags flagB(MyClass::FLAG_B);
...
TEST(FlagsT, operatorAnd_flagsItemAndFlagEnum_returnsIntersection)
{
    const MyClass::Flags all(MyClass::FLAG_ALL);
...
TEST(FlagsT, operatorAnd_flagEnumAndFlagsItem_returnsIntersection)
{
    const MyClass::Flags all(MyClass::FLAG_ALL);
...
TEST(FlagsT, operatorAnd_twoFlagsItems_returnsIntersection)
{
    const MyClass::Flags all(MyClass::FLAG_ALL);
    const MyClass::Flags flagA(MyClass::FLAG_A);
    const MyClass::Flags flagC(MyClass::FLAG_C);
...
TEST(FlagsT, operatorOr_twoFlagEnums_returnsUnion)
{
    MyClass::Flags item;
...
TEST(FlagsT, operatorOr_flagsItemAndFlagEnum_returnsUnion)
{
...
TEST(FlagsT, operatorOr_flagEnumAndFlagsItem_returnsUnion)
{
...
TEST(FlagsT, operatorOr_twoFlagsItems_returnsUnion)
{
    const MyClass::Flags lhs(MyClass::FLAG_A);
