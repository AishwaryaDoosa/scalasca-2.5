...
TEST_F(LocationSetT, getId_item_returnsIdentifier)
{
...
TEST_F(LocationSetT, getName_item_returnsName)
{
    LocationSet item0(0, String::UNDEFINED, mLocations);
...
TEST_F(LocationSetT, getType_item_returnsType)
{
...
TEST_F(LocationSetT, numLocations_emptyItem_returnsZero)
{
    LocationSet item(0, String::UNDEFINED, mLocations);
...
TEST_F(LocationSetT, numLocations_item_returnsMemberCount)
{
    createLocations(5);
...
TEST_F(LocationSetT, getLocation_itemAndValidRank_returnsMember)
{
    createLocations(3);
...
TEST_F(LocationSetT, getLocation_itemAndInvalidRank_throws)
{
    createLocations(3);
...
TEST_F(LocationSetT, operatorLeftShift_item_printsData)
{
    createLocations(2);
