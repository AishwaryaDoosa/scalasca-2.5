...
TEST(CartDimensionT, getId_item_returnsIdentifier)
{
...
TEST(CartDimensionT, getName_item_returnsName)
{
    CartDimension item0(0, String::UNDEFINED, 0, CartDimension::PERIODIC);
...
TEST(CartDimensionT, getSize_item_returnsSize)
{
...
TEST(CartDimensionT, isPeriodic_item_returnsPeriodicity)
{
...
TEST(CartDimensionT, operatorLeftShift_item_printsData)
{
    {
