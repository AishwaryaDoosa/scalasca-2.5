...
TEST(DefinitionTreeT, numRootItems_defaultTree_returnsZero)
{
...
TEST(DefinitionTreeT, getRootItemByIndex_validIndex_returnsItem)
{
    DefinitionTree< TestDef > tree;
...
TEST(DefinitionTreeT, getRootItemByIndex_invalidIndex_throws)
{
    DefinitionTree< TestDef > tree;
...
TEST(DefinitionTreeT, addItem_itemPtr_incrementsNumItems)
{
    DefinitionTree< TestDef > tree;
...
TEST(DefinitionTreeT, addItem_itemPtr_incrementsNumRootItems)
{
    DefinitionTree< TestDef > tree;
...
TEST(DefinitionTreeT, addItem_nullptr_throws)
{
    DefinitionTree< TestDef > tree;
...
TEST(DefinitionTreeT, optimizeLookups_treeWithUnsortedIds_keepsRootItems)
{
    DefinitionTree< TestDef > tree;
...
TEST(DefinitionTreeT, operatorLeftShift_defaultTreeToStream_printsNothing)
{
    DefinitionTree< TestDef > tree;
...
TEST(DefinitionTreeT, operatorLeftShift_nonEmptyTreeToStream_printsRootItems)
{
    DefinitionTree< TestDef > tree;
