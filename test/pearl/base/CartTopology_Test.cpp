...
TEST_F(CartTopologyT, getId_item_returnsIdentifier)
{
...
TEST_F(CartTopologyT, getName_item_returnsName)
{
    CartTopology item0(0, String::UNDEFINED, Communicator::UNDEFINED,
                       mDimensions);
...
TEST_F(CartTopologyT, getCommunicator_item_returnsCommunicator)
{
    CartTopology item0(0, String::UNDEFINED, Communicator::UNDEFINED,
                       mDimensions);
...
TEST_F(CartTopologyT, numDimensions_item_returnsDimensionCount)
{
    CartTopology item0(0, String::UNDEFINED, Communicator::UNDEFINED,
                       mDimensions);
...
TEST_F(CartTopologyT, getDimension_itemAndValidIndex_returnsDimension)
{
    CartDimension dim0(0, String::UNDEFINED, 0, CartDimension::PERIODIC);
    mDimensions.push_back(&dim0);
    CartDimension dim1(1, String::UNDEFINED, 0, CartDimension::PERIODIC);
...
TEST_F(CartTopologyT, getDimension_itemAndInvalidIndex_throws)
{
    CartTopology item(0, String::UNDEFINED, Communicator::UNDEFINED,
                      mDimensions);
...
TEST_F(CartTopologyT, getRankCoordinates_item_returnsEmptyList)
{
...
TEST_F(CartTopologyT, getRankCoordinates_itemAndInvalidRank_throws)
{
    CartTopology item(0, String::UNDEFINED, Communicator::UNDEFINED,
                      mDimensions);
...
TEST_F(CartTopologyT, operatorLeftShift_item_printsData)
{
