...
TEST_F(MemoryChunkTreeT, insert_chunks_buildsExpectedSplayTree)
{
    MemoryChunk* root = 0;
    //  nil
...
TEST_F(MemoryChunkTreeT, remove_rootNodes_buildsExpectedTree)
{
    MemoryChunk* root = 0;
    //  nil
...
//  A   B                 B   C
//
TEST_F(MemoryChunkTreeT, splay_zigCaseLeft_performsSingleRightRotation)
{
...
//    B   A             C   B
//
TEST_F(MemoryChunkTreeT, splay_zigCaseRight_performsSingleLeftRotation)
{
...
//  A   B                     C   D
//
TEST_F(MemoryChunkTreeT, splay_zigZigCaseLeft_performsTwoSingleRightRotations)
{
    MemoryChunk* A = mChunks[0];
    MemoryChunk* x = mChunks[1];
    MemoryChunk* B = mChunks[2];
...
//      B   A             D   C
//
TEST_F(MemoryChunkTreeT, splay_zigZigCaseRight_performsTwoSingleLeftRotations)
{
...
//    B   C
//
TEST_F(MemoryChunkTreeT, splay_zigZagCaseLeft_performsLeftRightRotation)
{
    MemoryChunk* A = mChunks[0];
    MemoryChunk* y = mChunks[1];
    MemoryChunk* B = mChunks[2];
...
//  C   B
//
TEST_F(MemoryChunkTreeT, splay_zigZagCaseRight_performsRightLeftRotation)
{
    MemoryChunk* D = mChunks[0];
    MemoryChunk* z = mChunks[1];
    MemoryChunk* C = mChunks[2];
...
//                            a
//
TEST_F(MemoryChunkTreeT, splay_ptrNotInTree_movesNearestNodeToRoot)
{
    MemoryChunk* c = mChunks[0];
...
//  A   B                 B   C
//
TEST_F(MemoryChunkTreeT, rotateLeft_tree_performsSingleLeftRotation)
{
    MemoryChunk* A = mChunks[0];
    MemoryChunk* x = mChunks[1];
    MemoryChunk* B = mChunks[2];
...
//  A   B                 B   C
//
TEST_F(MemoryChunkTreeT, rotateRight_tree_performsSingleRightRotation)
{
    MemoryChunk* A = mChunks[0];
    MemoryChunk* x = mChunks[1];
    MemoryChunk* B = mChunks[2];
