...
TEST_P(MemoryChunkT, capacity_testConfig_returnsCapacity)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, availableBlocks_emptyChunk_returnsCapacity)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, allocate_chunk_decrementsAvailableBlocks)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, allocate_chunk_returnsPointerWithinChunk)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, allocate_newChunk_returnsConsecutiveBlocks)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, allocate_usedChunk_returnsBlocksInReverseDeallocOrder)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, deallocate_chunk_incrementsAvailableBlocks)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, isLessThan_chunkAndLowerAddress_returnsFalse)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, isLessThan_chunkAndHigherAddress_returnsTrue)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, isGreaterThan_chunkAndLowerAddress_returnsTrue)
{
    const TestConfig& cfg = GetParam();
...
TEST_P(MemoryChunkT, isGreaterThan_chunkAndHigherAddress_returnsFalse)
{
    const TestConfig& cfg = GetParam();
